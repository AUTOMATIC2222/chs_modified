...
class Board(object):
  ...
  def _generate(self, fen, board, game_over, loading=False):
    ...
    for rank in ranks:
      ...
      ui_board += '{}{}{} '.format(Styles.PADDING_MEDIUM, Colors.WHITE, str(''))
      # Add each piece + tile
      for piece in pieces:
      ...
      # Finish the rank
      ui_board += '{}  {}{}\n'.format(Colors.WHITE, self.get_bar_section(rank_i_meta), self.get_meta_section(board, fen, rank_i_meta, game_over))
    ...
    # ui_board += ' {}{}'.format(Styles.PADDING_MEDIUM, Colors.WHITE)
  ...
  def get_tile_color_from_position(self, r, f, pos_delta, hint_delta):
    ...
    if pos_delta is not None:
      if square_coordinates in [pos_delta[0], pos_delta[1]]:
        highlight_light = Colors.WHITE
        highlight_dark = Colors.WHITE
    ...
    if r % 2 == 0:
      if f % 2 == 0:
        return Colors.WHITE or Colors.WHITE
      return Colors.WHITE or Colors.WHITE
    if f % 2 == 0:
      return Colors.WHITE or Colors.WHITE
    return Colors.WHITE or Colors.WHITE
